    ...
    <footer className=" w-full bg-[#40A63D] text-white py-6 md:py-10 ">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <h3 className="text-white text-xl font-medium mb-4">Contact Info</h3>
          ...
          <div>
            <h3 className="text-white text-xl font-medium mb-4">Useful Links</h3>
            <ul className="space-y-2">
              ...
              <li className="mb-2">
                <a href="/course" className="hover:text-yellow-500 transition duration-300 text-xl">
                Our Courses
                </a>
              </li>
              <li className="mb-2">
