...
const subheadings = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M12 2C7.03 2 3 6.03 3 11c0 3.87 2.69 7.13 6.39 7.84.35.06.61.37.61.74v.67c0 .41.34.75.75.75h2.5a.75.75 0 00.75-.75v-.67c0-.37.26-.68.61-.74A8.999 8.999 0 0021 11c0-4.97-4.03-9-9-9z"
          strokeWidth="2"
        />
      </svg>
    ),
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M12 21C12 21 4 13.954 4 8.5C4 5.462 6.462 3 9.5 3C11.014 3 12.417 3.755 13 5C13.583 3.755 14.986 3 16.5 3C19.538 3 22 5.462 22 8.5C22 13.954 12 21 12 21Z"
          strokeWidth="2"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M9 2l2 4-3 1 1 3-3 1 2 4-3 1 2 4M15 2l2 4-3 1 1 3-3 1 2 4-3 1 2 4"
          strokeWidth="2"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M12 6a6 6 0 00-6 6v4a4 4 0 004 4h4a4 4 0 004-4v-4a6 6 0 00-6-6z"
          strokeWidth="2"
        />
      </svg>
    ),
...
const TherapeuticAreas = () => (
  <section className="bg-lbl py-16 relative mb-[50px]">
