...
import StudyTime from "../assets/StudyTime.jpg";
import placementTime from "../assets/placementTime.jpg";
import EasyAccess from "../assets/EasyAccess.jpg";
import StudyGo from "../assets/StudyGo.jpg";
import GetInnovative from "../assets/GetInnovative.jpg";
import PracticalTime from "../assets/PracticalTime.jpg";
...
const FeatureCard = ({ icon, title, description }) => {
  return (
    <div className="flex flex-col items-center p-5 sm:p-6 text-center border border-gray-200 bg-white rounded-lg shadow hover:shadow-md transition-shadow duration-300">
      <div className={`w-16 h-16 mb-4 flex items-center justify-center rounded-md overflow-hidden ${icon.bgColor}`}>
        {icon.img ? (
...
const ServiceSection = () => {
  const features = [
    {
      icon: { bgColor: "bg-blue-500", img: StudyTime },
    ...
    {
      icon: { bgColor: "bg-green-500", img: placementTime },
    ...
    {
      icon: { bgColor: "bg-yellow-500", img: EasyAccess },
    ...
    {
      icon: { bgColor: "bg-yellow-500", img: StudyGo },
      title: "Training",
    ...
    {
      icon: { bgColor: "bg-blue-500", img: GetInnovative },
    ...
    {
      icon: { bgColor: "bg-green-500", img: PracticalTime },
    ...
    {
      icon: { bgColor: "bg-purple-500", img: null },
    ...
    {
      icon: { bgColor: "bg-pink-500", img: null },
    ...
    {
      icon: { bgColor: "bg-red-500", img: null },
