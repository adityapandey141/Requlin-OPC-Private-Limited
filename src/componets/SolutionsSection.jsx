  ...
  const studyOptions = [
    {
      ...
      description: "We assist in designing robust study protocols, ensuring clarity and compliance from the outset.",
      color: "#FF7F00", 
      image: Studyimg1,
    },
    {
      title: "Study Review",
      description: " Our expert team conducts thorough reviews to identify potential challenges and streamline study processes.",
      color: "#32CD32", 
      image: Studyimg2,
    },
    {
      title: " Site Enablement",
      description: " We provide support to research sites, enhancing their capabilities to conduct efficient and compliant trials.",
      color: "#1E90FF", 
      image: Studyimg3,
    }
  ];
